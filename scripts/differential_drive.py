...
class micro_mouse:
    ...
    def dd_callback(self,data):
        ...
        '''
        self.curr_x = data.pose[2].position.x
        self.curr_y = data.pose[2].position.y
        x = data.pose[2].orientation.x
        y = data.pose[2].orientation.y
        z = data.pose[2].orientation.z
        w = data.pose[2].orientation.w
